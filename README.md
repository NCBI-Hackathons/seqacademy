...
`conda create -n tutorial jupyter hisat2 multiqc macs2 bioconductor-deseq2 bioconductor-rtracklayer matplotlib ggplot samtools bioconductor-rsamtools bedtools htseq  --yes`
